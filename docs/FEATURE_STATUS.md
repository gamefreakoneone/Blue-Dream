...
| 0008 | Proactive Channel | Completed | `docs/specs/0008-proactive-channel/status.md` | 118 tests pass; isolated live Qwen/API rehearsal verifies all four triggers, expiry, global delivery, daily rollover, event dedupe/re-arm, conversation append, and rendered web acknowledgement. Geofence behavior remains unchanged. |
